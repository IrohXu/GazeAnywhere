...
model.freeze_text_encoder = False
model.inout = True
model.patch_size = 16
model.dim = 256
# dataloader
...
# train
train.init_checkpoint = "/projects/illinois/eng/cs/jrehg/users/xucao2/ChildGaze/output/anygaze_dinov3txt_large_text_concept_256/model_final.pth"

...
from modeling.backbone.src.dinov3.logging import MetricLogger
...
from modeling.backbone.src.dinov3.eval.depth.metrics import calculate_depth_metrics, _DepthMetric, DEPTH_METRICS
from modeling.backbone.src.dinov3.eval.depth.transforms import Aug, LeftRightFlipAug
from modeling.backbone.src.dinov3.eval.depth.utils import align_depth_least_square
from modeling.backbone.src.dinov3.eval.depth.visualization_utils import depth_tensor_to_colorized_pil, save_predictions

...
from modeling.backbone.src.dinov3.eval.segmentation.config import SegmentationConfig
from modeling.backbone.src.dinov3.eval.segmentation.eval import test_segmentation
from modeling.backbone.src.dinov3.eval.segmentation.train import train_segmentation

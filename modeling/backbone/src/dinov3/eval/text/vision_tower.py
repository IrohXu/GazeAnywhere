...
from modeling.backbone.src.dinov3.layers import SelfAttentionBlock, SwiGLUFFN
from modeling.backbone.src.dinov3.models.vision_transformer import init_weights_vit
from modeling.backbone.src.dinov3.utils import named_apply
...
def build_vision_model(
    ...
    if backbone is None:
        if backbone_model_config is not None:
            ...
            from modeling.backbone.src.dinov3.models import build_model_from_cfg as build_vision_backbone

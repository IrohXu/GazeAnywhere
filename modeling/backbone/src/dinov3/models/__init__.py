...
from modeling.backbone.src.dinov3.layers.fp8_linear import convert_linears_to_fp8
...
def build_model_for_eval(
    ...
    if pretrained_weights is None or pretrained_weights == "":
        ...
        from modeling.backbone.src.dinov3.checkpointer import load_checkpoint
        ...
        from modeling.backbone.src.dinov3.checkpointer import init_model_from_checkpoint_for_evals
